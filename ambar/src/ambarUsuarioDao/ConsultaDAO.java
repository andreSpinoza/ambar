...
public class ConsultaDAO {
	...
	public void inicializar(String path)
	{
		try
		{
			...
			cadenaConexion = prop.getProperty("fn3.oracle.virtual.uniandes.edu.co");	// El url, el usuario y passwd deben estar en un archivo de propiedades.
