...
public abstract class ServletTemplate extends HttpServlet {
	 ...
	 * hechas por los matodos get. Invoca el matodo procesarPedido.
	 * @param request pedido del cliente
	 * @param response respuesta del servlet
	 * @throws IOException Excepcian de error al escribir la respuesta
	 */
	...
	/**
	 * Recibe la solicitud y la herramienta de respuesta a las solicitudes
	 * hechas por los matodos post. Invoca el matodo procesarPedido.
	 * @param request pedido del cliente
	 * @param response respuesta del servlet
	 * @throws IOException Excepcian de error al escribir la respuesta
	 */
    ...
    private void procesarPedido( HttpServletRequest request, HttpServletResponse response ) throws IOException
    {
    	...
    	AmbarUsuario.darInstancia().inicializarRuta(this.getServletContext().getRealPath(((HttpServletRequest) this.getServletContext()).getContextPath()));
        //
     ...
     * @param request pedido del cliente
     * @param response respuesta del servlet
     * @throws IOException Excepcian de error al recibir la respuesta
     */
	...
	private void imprimirFooter(HttpServletResponse response) throws IOException
	{
        ...
        respuesta.println( "               &nbsp;" );
        respuesta.println( "               Todos los derechos no reservados (excepto las imagenes).<br>" );
    ...
    protected void imprimirMensajeError( PrintWriter respuesta, String titulo, String mensaje )
    {
        ...
        respuesta.println( "                      operacian nuevamente. Si el problema persiste, contacte " );
        respuesta.println( "                      al administrador del sistema.</p>" );
        respuesta.println( "                      <p><a href=\"index.htm\">Volver a la pagina principal</a>" );
    }
    ...
    /**
     * Imprime un mensaje de axito
     * @param respuesta Respuesta al cliente
     * @param titulo Tatulo del mensaje
     * @param mensaje Contenido del mensaje
     */
    protected void imprimirMensajeOk( PrintWriter respuesta, String titulo, String mensaje )
    {
        respuesta.println( "                      <p class=\"ok\"><b>Operacian exitosa:<br>" );
        respuesta.println( "                      </b>" + titulo + "</p><p>" + mensaje + ". </p>" );
        respuesta.println( "                      <p><a href=\"index.htm\">Volver a la pagina principal</a>" );
    }
    ...
    /**
     * Devuelve el tatulo de la pagina para el Header
     * @param request Pedido del cliente
     * @return Tatulo de la pagina para el Header
     */
    public abstract String darTituloPagina( HttpServletRequest request );

    /**
     * Devuelve el nombre de la imagen para el tatulo de la pagina en el Header
     * @param request Pedido del cliente
     * @return Nombre de la imagen para el tatulo de la pagina en el Header
     */
