 ...
 */
public class ConsultaCuentaDAO {
	 ...
	 */
	private static final String consultaVideosDefault="SELECT *, FROM "+tablaUsuario;
     ...
     */
    public ArrayList<CuentaValue> darCuentasDefault() throws Exception
    {
    	PreparedStatement prepStmt = null;
    	
    	ArrayList<CuentaValue> cuentas = new ArrayList<CuentaValue>();
    	CuentaValue usValue = new CuentaValue();
