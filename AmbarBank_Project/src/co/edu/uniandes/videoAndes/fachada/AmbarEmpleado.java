...
import co.edu.uniandes.videoAndes.dao.ConsultaEmpleadoDAO;
import co.edu.uniandes.videoAndes.vos.EmpleadoValue;

/**
 * Clase AmbarEmpleado, que representa la fachada de comunicacin entre
 * la interfaz y la conexin con la base de datos. Atiende todas
 * las solicitudes.
 */
public class AmbarEmpleado {

	/**
	 * Conexin con la clase que maneja la base de datos
	 */
	private ConsultaEmpleadoDAO dao;
     ...
     */
    private static AmbarEmpleado instancia;
    
    /**
     * Devuelve la instancia nica de la clase
     * @return Instancia nica de la clase
     */
    public static AmbarEmpleado darInstancia( )
    {
        if( instancia == null )
        {
            instancia = new AmbarEmpleado( );
        }
        return instancia;
    }
	 ...
	 */
	private AmbarEmpleado()
	{
		dao = new ConsultaEmpleadoDAO();
	}
	...
	{
	    return dao.darEmpleadosDefault();
	}
