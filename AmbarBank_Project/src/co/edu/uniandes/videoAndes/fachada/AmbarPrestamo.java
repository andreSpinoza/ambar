...
import co.edu.uniandes.videoAndes.dao.ConsultaPrestamoDAO;
import co.edu.uniandes.videoAndes.vos.PrestamoValue;

/**
 * Clase AmbarPrestamo, que representa la fachada de comunicacin entre
 * la interfaz y la conexin con la base de datos. Atiende todas
 * las solicitudes.
 */
public class AmbarPrestamo {

	/**
	 * Conexin con la clase que maneja la base de datos
	 */
	private ConsultaPrestamoDAO dao;
     ...
     */
    private static AmbarPrestamo instancia;
    
    /**
     * Devuelve la instancia nica de la clase
     * @return Instancia nica de la clase
     */
    public static AmbarPrestamo darInstancia( )
    {
        if( instancia == null )
        {
            instancia = new AmbarPrestamo( );
        }
        return instancia;
    }
	 ...
	 */
	private AmbarPrestamo()
	{
		dao = new ConsultaPrestamoDAO();
	}
	...
	{
	    return dao.darPrestamosDefault();
	}
